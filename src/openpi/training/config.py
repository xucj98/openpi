...
_CONFIGS = [
    ...
    TrainConfig(
            ...
            exp_name="table_clean_pi05_sm2sm_v2_h3f3_a30_autoacc_0_4",
        ),

        TrainConfig(
            name="table_clean_pi05_sm2sm_30hz_autoacc_0_4",
            model=pi0_config.Pi0Config(
                pi05=True,
                action_horizon=30,
                pi05_state_sequence_in_suffix=True,
            ...
            data=LeRobotX2robotDataConfig(
                repo_id="table_clean_x1pro_sm2sm_30hz_v2",
                mode="sm2sm",
                state_history_size=3,
                state_future_size=3,
                action_dim=28,
            ...
            batch_size=32,
            num_train_steps=40_000,
            exp_name="table_clean_pi05_sm2sm_v2_h3f3_a30_30hz_autoacc_0_4",
        ),
    TrainConfig(
                name="table_clean_pi05_sm2sm_30hz",
                model=pi0_config.Pi0Config(
                    pi05=True,
                    action_horizon=30,
                    pi05_state_sequence_in_suffix=True,
                ...
                batch_size=32,
                num_train_steps=40_000,
                exp_name="table_clean_pi05_sm2sm_v2_h3f3_a30_30hz",
            ),    
    TrainConfig(
    ...
    TrainConfig(
        name="pen_in_cup_pi05_sm2sm_30hz",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=20,
            pi05_state_sequence_in_suffix=True,
        ...
        data=LeRobotX2robotDataConfig(
            repo_id="pen_in_cup_x1pro_sm2sm_30hz",
            mode="sm2sm",
            state_history_size=3,
            state_future_size=3,
            action_dim=28,
        ...
        batch_size=32,
        num_train_steps=40_000,
        exp_name="pen_in_cup_pi05_sm2sm_v2_h3f3_a20_30hz",
    ),
    TrainConfig(
        name="stack_plate_pi05_sm2sm_30hz",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=20,
            pi05_state_sequence_in_suffix=True,
        ...
        data=LeRobotX2robotDataConfig(
            repo_id="stack_plate_x1pro_sm2sm_30hz",
            mode="sm2sm",
            state_history_size=3,
            state_future_size=3,
            action_dim=28,
        ...
        batch_size=32,
        num_train_steps=40_000,
        exp_name="stack_plate_pi05_sm2sm_v2_h3f3_a20_30hz",
        ),

    TrainConfig(
            name="put_in_box_pi05_sm2sm_30hz",
            model=pi0_config.Pi0Config(
                pi05=True,
                action_horizon=20,
                pi05_state_sequence_in_suffix=True,
            ...
            data=LeRobotX2robotDataConfig(
                repo_id="put_in_box_x1pro_sm2sm_30hz",
                mode="sm2sm",
                state_history_size=3,
                state_future_size=3,
                action_dim=28,
            ...
            batch_size=32,
            num_train_steps=40_000,
            exp_name="put_in_box_pi05_sm2sm_v2_h3f3_a20_30hz",
        ),    

        TrainConfig(
                name="plug_charger_pi05_sm2sm_30hz",
                model=pi0_config.Pi0Config(
                    pi05=True,
                    action_horizon=20,
                    pi05_state_sequence_in_suffix=True,
                ...
                data=LeRobotX2robotDataConfig(
                    repo_id="plug_charger_x1pro_sm2sm_30hz",
                    mode="sm2sm",
                    state_history_size=3,
                    state_future_size=3,
                    action_dim=28,
                ...
                batch_size=32,
                num_train_steps=40_000,
                exp_name="plug_charger_pi05_sm2sm_v2_h3f3_a20_30hz",
            ),
